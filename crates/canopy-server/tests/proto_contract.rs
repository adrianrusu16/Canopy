use canopy_proto::{
    catalog_service_server::CatalogService, discovery_service_server::DiscoveryService,
    history_service_server::HistoryService, library_service_server::LibraryService,
    playback_service_server::PlaybackService, playlist_service_server::PlaylistService,
    profile_service_server::ProfileService, system_service_server::SystemService,
};
use canopy_server::api::grpc::{
    CatalogGrpc, DiscoveryGrpc, HistoryGrpc, LibraryGrpc, PlaybackGrpc, PlaylistGrpc, ProfileGrpc,
    SystemGrpc,
};
